...
/**
     ...
     */
    public function configuratorServiceGetCalculation($params_cpu_count = null, $params_disk_size = null, $params_memory = null, $region = null, $vps_id = null, $software_id = null, $snapshot_id = null, string $contentType = self::contentTypes['configuratorServiceGetCalculation'][0])
    {
        list($response) = $this->configuratorServiceGetCalculationWithHttpInfo($params_cpu_count, $params_disk_size, $params_memory, $region, $vps_id, $software_id, $snapshot_id, $contentType);
        return $response;
    }
     ...
     */
    public function configuratorServiceGetCalculationWithHttpInfo($params_cpu_count = null, $params_disk_size = null, $params_memory = null, $region = null, $vps_id = null, $software_id = null, $snapshot_id = null, string $contentType = self::contentTypes['configuratorServiceGetCalculation'][0])
    {
        $request = $this->configuratorServiceGetCalculationRequest($params_cpu_count, $params_disk_size, $params_memory, $region, $vps_id, $software_id, $snapshot_id, $contentType);
     ...
     */
    public function configuratorServiceGetCalculationAsync($params_cpu_count = null, $params_disk_size = null, $params_memory = null, $region = null, $vps_id = null, $software_id = null, $snapshot_id = null, string $contentType = self::contentTypes['configuratorServiceGetCalculation'][0])
    {
        return $this->configuratorServiceGetCalculationAsyncWithHttpInfo($params_cpu_count, $params_disk_size, $params_memory, $region, $vps_id, $software_id, $snapshot_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function configuratorServiceGetCalculationAsyncWithHttpInfo($params_cpu_count = null, $params_disk_size = null, $params_memory = null, $region = null, $vps_id = null, $software_id = null, $snapshot_id = null, string $contentType = self::contentTypes['configuratorServiceGetCalculation'][0])
    {
        $returnType = '\OpenAPI\Client\Model\ConfiguratorGetCalculationResponse';
        $request = $this->configuratorServiceGetCalculationRequest($params_cpu_count, $params_disk_size, $params_memory, $region, $vps_id, $software_id, $snapshot_id, $contentType);
     ...
     */
    public function configuratorServiceGetCalculationRequest($params_cpu_count = null, $params_disk_size = null, $params_memory = null, $region = null, $vps_id = null, $software_id = null, $snapshot_id = null, string $contentType = self::contentTypes['configuratorServiceGetCalculation'][0])
    {
     ...
     */
    public function configuratorServiceGetConfiguratorInfo($region = null, string $contentType = self::contentTypes['configuratorServiceGetConfiguratorInfo'][0])
    {
        list($response) = $this->configuratorServiceGetConfiguratorInfoWithHttpInfo($region, $contentType);
        return $response;
    }
     ...
     */
    public function configuratorServiceGetConfiguratorInfoWithHttpInfo($region = null, string $contentType = self::contentTypes['configuratorServiceGetConfiguratorInfo'][0])
    {
        $request = $this->configuratorServiceGetConfiguratorInfoRequest($region, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function configuratorServiceGetConfiguratorInfoAsync($region = null, string $contentType = self::contentTypes['configuratorServiceGetConfiguratorInfo'][0])
    {
        return $this->configuratorServiceGetConfiguratorInfoAsyncWithHttpInfo($region, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function configuratorServiceGetConfiguratorInfoAsyncWithHttpInfo($region = null, string $contentType = self::contentTypes['configuratorServiceGetConfiguratorInfo'][0])
    {
        $returnType = '\OpenAPI\Client\Model\ConfiguratorGetConfiguratorInfoResponse';
        $request = $this->configuratorServiceGetConfiguratorInfoRequest($region, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function configuratorServiceGetConfiguratorInfoRequest($region = null, string $contentType = self::contentTypes['configuratorServiceGetConfiguratorInfo'][0])
    {

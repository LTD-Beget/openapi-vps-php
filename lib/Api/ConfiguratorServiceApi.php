...
/**
     ...
     */
    public function configuratorServiceGetCalculation($params_cpu_count = null, $params_disk_size = null, $params_memory = null, $vps_id = null, string $contentType = self::contentTypes['configuratorServiceGetCalculation'][0])
    {
        list($response) = $this->configuratorServiceGetCalculationWithHttpInfo($params_cpu_count, $params_disk_size, $params_memory, $vps_id, $contentType);
        return $response;
    }
     ...
     */
    public function configuratorServiceGetCalculationWithHttpInfo($params_cpu_count = null, $params_disk_size = null, $params_memory = null, $vps_id = null, string $contentType = self::contentTypes['configuratorServiceGetCalculation'][0])
    {
        $request = $this->configuratorServiceGetCalculationRequest($params_cpu_count, $params_disk_size, $params_memory, $vps_id, $contentType);
     ...
     */
    public function configuratorServiceGetCalculationAsync($params_cpu_count = null, $params_disk_size = null, $params_memory = null, $vps_id = null, string $contentType = self::contentTypes['configuratorServiceGetCalculation'][0])
    {
        return $this->configuratorServiceGetCalculationAsyncWithHttpInfo($params_cpu_count, $params_disk_size, $params_memory, $vps_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function configuratorServiceGetCalculationAsyncWithHttpInfo($params_cpu_count = null, $params_disk_size = null, $params_memory = null, $vps_id = null, string $contentType = self::contentTypes['configuratorServiceGetCalculation'][0])
    {
        $returnType = '\OpenAPI\Client\Model\ConfiguratorGetCalculationResponse';
        $request = $this->configuratorServiceGetCalculationRequest($params_cpu_count, $params_disk_size, $params_memory, $vps_id, $contentType);
     ...
     */
    public function configuratorServiceGetCalculationRequest($params_cpu_count = null, $params_disk_size = null, $params_memory = null, $vps_id = null, string $contentType = self::contentTypes['configuratorServiceGetCalculation'][0])
    {

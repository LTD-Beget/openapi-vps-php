...
/**
    ...
    /**
     * Operation manageServiceGetSoftwareList
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['manageServiceGetSoftwareList'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\ManageGetSoftwareListResponse
     */
    public function manageServiceGetSoftwareList(string $contentType = self::contentTypes['manageServiceGetSoftwareList'][0])
    {
        list($response) = $this->manageServiceGetSoftwareListWithHttpInfo($contentType);
        return $response;
    }

    /**
     * Operation manageServiceGetSoftwareListWithHttpInfo
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['manageServiceGetSoftwareList'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\ManageGetSoftwareListResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function manageServiceGetSoftwareListWithHttpInfo(string $contentType = self::contentTypes['manageServiceGetSoftwareList'][0])
    {
        $request = $this->manageServiceGetSoftwareListRequest($contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\ManageGetSoftwareListResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\ManageGetSoftwareListResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\ManageGetSoftwareListResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\OpenAPI\Client\Model\ManageGetSoftwareListResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\ManageGetSoftwareListResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation manageServiceGetSoftwareListAsync
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['manageServiceGetSoftwareList'] to see the possible values for this operation
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function manageServiceGetSoftwareListAsync(string $contentType = self::contentTypes['manageServiceGetSoftwareList'][0])
    {
        return $this->manageServiceGetSoftwareListAsyncWithHttpInfo($contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation manageServiceGetSoftwareListAsyncWithHttpInfo
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['manageServiceGetSoftwareList'] to see the possible values for this operation
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function manageServiceGetSoftwareListAsyncWithHttpInfo(string $contentType = self::contentTypes['manageServiceGetSoftwareList'][0])
    {
        $returnType = '\OpenAPI\Client\Model\ManageGetSoftwareListResponse';
        $request = $this->manageServiceGetSoftwareListRequest($contentType);
    ...
    /**
     * Create request for operation 'manageServiceGetSoftwareList'
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['manageServiceGetSoftwareList'] to see the possible values for this operation
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    public function manageServiceGetSoftwareListRequest(string $contentType = self::contentTypes['manageServiceGetSoftwareList'][0])
    {

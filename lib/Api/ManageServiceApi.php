...
/**
    ...
    public function manageServiceAttachIpAddressRequest($id, $ip_address, $manage_attach_ip_address_request, string $contentType = self::contentTypes['manageServiceAttachIpAddress'][0])
    {
        ...
        if (isset($manage_attach_ip_address_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                ...
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($manage_attach_ip_address_request));
            } else {
    ...
    public function manageServiceAttachToPrivateNetworkRequest($id, $network_id, $manage_attach_to_private_network_request, string $contentType = self::contentTypes['manageServiceAttachToPrivateNetwork'][0])
    {
        ...
        if (isset($manage_attach_to_private_network_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($manage_attach_to_private_network_request));
            } else {
    ...
    public function manageServiceBindProjectRequest($id, $manage_bind_project_request, string $contentType = self::contentTypes['manageServiceBindProject'][0])
    {
        ...
        if (isset($manage_bind_project_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($manage_bind_project_request));
            } else {
    ...
    public function manageServiceChangeConfigurationRequest($id, $manage_change_configuration_request, string $contentType = self::contentTypes['manageServiceChangeConfiguration'][0])
    {
        ...
        if (isset($manage_change_configuration_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($manage_change_configuration_request));
            } else {
    ...
    public function manageServiceChangePinnedRequest($id, $manage_change_pinned_request, string $contentType = self::contentTypes['manageServiceChangePinned'][0])
    {
        ...
        if (isset($manage_change_pinned_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($manage_change_pinned_request));
            } else {
    ...
    public function manageServiceChangeSshAccessRequest($id, $manage_change_ssh_access_request, string $contentType = self::contentTypes['manageServiceChangeSshAccess'][0])
    {
        ...
        if (isset($manage_change_ssh_access_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($manage_change_ssh_access_request));
            } else {
    ...
    public function manageServiceCheckSoftwareRequirementsRequest($manage_check_software_requirements_request, string $contentType = self::contentTypes['manageServiceCheckSoftwareRequirements'][0])
    {
        ...
        if (isset($manage_check_software_requirements_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($manage_check_software_requirements_request));
            } else {
    ...
    public function manageServiceCreateVpsRequest($manage_create_vps_request, string $contentType = self::contentTypes['manageServiceCreateVps'][0])
    {
        ...
        if (isset($manage_create_vps_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($manage_create_vps_request));
            } else {
    ...
    public function manageServiceReinstallRequest($id, $manage_reinstall_request, string $contentType = self::contentTypes['manageServiceReinstall'][0])
    {
        ...
        if (isset($manage_reinstall_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($manage_reinstall_request));
            } else {
     ...
     *
     * @param  string $id id (required)
     * @param  \OpenAPI\Client\Model\ManageRemoveVpsRequest $manage_remove_vps_request manage_remove_vps_request (required)
     ...
     */
    public function manageServiceRemoveVps($id, $manage_remove_vps_request, string $contentType = self::contentTypes['manageServiceRemoveVps'][0])
    {
        list($response) = $this->manageServiceRemoveVpsWithHttpInfo($id, $manage_remove_vps_request, $contentType);
        return $response;
    }
     ...
     *
     * @param  string $id (required)
     * @param  \OpenAPI\Client\Model\ManageRemoveVpsRequest $manage_remove_vps_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['manageServiceRemoveVps'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     */
    public function manageServiceRemoveVpsWithHttpInfo($id, $manage_remove_vps_request, string $contentType = self::contentTypes['manageServiceRemoveVps'][0])
    {
        $request = $this->manageServiceRemoveVpsRequest($id, $manage_remove_vps_request, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function manageServiceRemoveVpsAsync($id, $manage_remove_vps_request, string $contentType = self::contentTypes['manageServiceRemoveVps'][0])
    {
        return $this->manageServiceRemoveVpsAsyncWithHttpInfo($id, $manage_remove_vps_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function manageServiceRemoveVpsAsyncWithHttpInfo($id, $manage_remove_vps_request, string $contentType = self::contentTypes['manageServiceRemoveVps'][0])
    {
        $returnType = '\OpenAPI\Client\Model\ManageRemoveVpsResponse';
        $request = $this->manageServiceRemoveVpsRequest($id, $manage_remove_vps_request, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function manageServiceRemoveVpsRequest($id, $manage_remove_vps_request, string $contentType = self::contentTypes['manageServiceRemoveVps'][0])
    {
        ...
        // verify the required parameter 'manage_remove_vps_request' is set
        if ($manage_remove_vps_request === null || (is_array($manage_remove_vps_request) && count($manage_remove_vps_request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $manage_remove_vps_request when calling manageServiceRemoveVps'
            );
        }
        ...
        // for model (json/xml)
        if (isset($manage_remove_vps_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($manage_remove_vps_request));
            } else {
                $httpBody = $manage_remove_vps_request;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
    ...
    public function manageServiceUpdateInfoRequest($id, $manage_update_info_request, string $contentType = self::contentTypes['manageServiceUpdateInfo'][0])
    {
        ...
        if (isset($manage_update_info_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($manage_update_info_request));
            } else {

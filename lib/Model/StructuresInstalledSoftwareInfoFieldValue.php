...
/**
 * StructuresInstalledSoftwareInfoFieldValue Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class StructuresInstalledSoftwareInfoFieldValue implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Structures_InstalledSoftwareInfo_FieldValue';
    ...
    {
        $this->setIfExists('label_ru', $data ?? [], null);
    ...
    */
    ...
    {
        return $this->container['label_ru'];
    }

    /**
     * Sets label_ru
     *
     * @param string|null $label_ru label_ru
     *
     * @return self
     */
    public function setLabelRu($label_ru)
    {

        if (is_null($label_ru)) {
            throw new \InvalidArgumentException('non-nullable label_ru cannot be null');
        }

        $this->container['label_ru'] = $label_ru;

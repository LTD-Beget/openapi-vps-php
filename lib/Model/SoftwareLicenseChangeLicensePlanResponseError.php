...
/**
 * SoftwareLicenseChangeLicensePlanResponseError Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SoftwareLicenseChangeLicensePlanResponseError implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SoftwareLicense_ChangeLicensePlanResponse_Error';
    ...
    protected static $openAPITypes = [
        'code' => 'string',
        'message' => 'string',
        'insufficient_funds_error' => '\OpenAPI\Client\Model\SoftwareLicenseChangeLicensePlanResponseErrorInsufficientFundsError'
    ];
    ...
    */
     ...
     *
     * @return \OpenAPI\Client\Model\SoftwareLicenseChangeLicensePlanResponseErrorInsufficientFundsError|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\SoftwareLicenseChangeLicensePlanResponseErrorInsufficientFundsError|null $insufficient_funds_error insufficient_funds_error
     *
     * @return self
     */

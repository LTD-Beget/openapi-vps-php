...
class ManageCreateVpsResponseError implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const CODE_SOFTWARE_TEMPORARY_UNAVAILABLE = 'SOFTWARE_TEMPORARY_UNAVAILABLE';
    public const CODE_IMAGE_REGION_MISMATCH = 'IMAGE_REGION_MISMATCH';
    public const CODE_ADDRESS_NOT_OWNED = 'ADDRESS_NOT_OWNED';
    public const CODE_MULTIPLE_IPS_NOT_SUPPORTED_YET = 'MULTIPLE_IPS_NOT_SUPPORTED_YET';
    public const CODE_CONFLICTING_NETWORK_FIELDS = 'CONFLICTING_NETWORK_FIELDS';
    public const CODE_UNSUPPORTED_IP_VERSION = 'UNSUPPORTED_IP_VERSION';
    ...
    public function getCodeAllowableValues()
    {
        return [
            ...
            self::CODE_SOFTWARE_TEMPORARY_UNAVAILABLE,
            self::CODE_IMAGE_REGION_MISMATCH,
            self::CODE_ADDRESS_NOT_OWNED,
            self::CODE_MULTIPLE_IPS_NOT_SUPPORTED_YET,
            self::CODE_CONFLICTING_NETWORK_FIELDS,
            self::CODE_UNSUPPORTED_IP_VERSION,
        ];
    }

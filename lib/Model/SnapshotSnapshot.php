...
class SnapshotSnapshot implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('vps_exists', $data ?? [], null);
    ...
    */
     ...
     * @return bool|null
     */
    public function getVpsExists()
    {
        return $this->container['vps_exists'];
    }

    /**
     * Sets vps_exists
     *
     * @param bool|null $vps_exists vps_exists
     *
     * @return self
     */
    public function setVpsExists($vps_exists)
    {
        if (is_null($vps_exists)) {
            throw new \InvalidArgumentException('non-nullable vps_exists cannot be null');
        }
        $this->container['vps_exists'] = $vps_exists;

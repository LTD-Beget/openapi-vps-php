...
class MarketplaceSoftwareInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $setters = [
        ...
        'requires_public_ip' => 'setRequiresPublicIp'
    ];
    ...
    protected static $getters = [
        ...
        'requires_public_ip' => 'getRequiresPublicIp'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('requires_public_ip', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets requires_public_ip
     *
     * @return bool|null
     */
    public function getRequiresPublicIp()
    {
        return $this->container['requires_public_ip'];
    }

    /**
     * Sets requires_public_ip
     *
     * @param bool|null $requires_public_ip requires_public_ip
     *
     * @return self
     */
    public function setRequiresPublicIp($requires_public_ip)
    {
        if (is_null($requires_public_ip)) {
            throw new \InvalidArgumentException('non-nullable requires_public_ip cannot be null');
        }
        $this->container['requires_public_ip'] = $requires_public_ip;
